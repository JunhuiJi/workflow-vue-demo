<template>
  <div>
    ...
    >
      ...
      <el-table-column property="assignee" label="受托人"/>
      <el-table-column property="finishDate" label="完成时间"/>
    </el-table>
    <div class="top-margin">
      业务操作工具栏
    </div>
...
const initialTableData: UserTask[] = [
  ...
  },
  {
    ...
    description: '描述-0-1',
    assignee: '用户-0',
    finishDate: '2023-10-01 08:00:00',
    businessKey: '1',
    actions: '业务操作-0#业务操作-1',
  },
  {
    ...
    description: '描述-1-0',
    assignee: '用户-1',
    finishDate: '2023-10-01 07:00:00',
    businessKey: '2',
  ...
  },
  {
    ...
    description: '描述-1-1',
    assignee: '用户-2',
    finishDate: '2023-10-01 06:00:00',
    businessKey: '3',
    actions: '业务操作-2#业务操作-3',
  },
]
